#!/usr/bin/env python3
"""
Eleven Stage Pipeline Implementation - Fixed Version
...
class ElevenStagePipeline:
    ...
    async def process_batch(self, 
        ...
        try:
            ...
            for idx, doc in enumerate(documents):
                ...
                self.stats['reporters_normalized'] += normalized_reporters['count']
    ...
    def _enhance_court_info(self, document: Dict[str, Any]) -> Dict[str, Any]:
        ...
        court_hint = metadata.get('court_id', '') or metadata.get('court', '') or metadata.get('court_name', '') or 'Eastern District of Texas'
...
async def main():
    ...
    print("\n" + "🚀 " * 20)
    print("ELEVEN STAGE PIPELINE - FIXED IMPLEMENTATION")
    print("🚀 " * 20 + "\n")
