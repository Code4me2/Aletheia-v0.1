...
class EnhancedElevenStagePipeline:
    ...
    async def process_batch(self, 
        ...
        try:
            ...
            if self.db_conn:
                self.db_conn.close()# Part 2 of eleven_stage_pipeline_enhanced.py
# Type-specific processing methods
    ...
    def _enhance_judge_info_opinion(self, document: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._enhance_judge_info_validated(document)# Part 3 of eleven_stage_pipeline_enhanced.py
